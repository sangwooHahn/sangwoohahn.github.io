...
function onScroll() {
	...
	if (getBrightness(bgColor_left) == 0 || getBrightness(bgColor_left) > 240) { //full white all 0 for the no bg color. it means white or no bg set (white)
		logoImage.src = 'images/all/portfolio_logo_black.png';
	} else {
		logoImage.src = 'images/all/portfolio_logo_white.png';
	}

	if (getBrightness(bgColor_right) == 0 || getBrightness(bgColor_right) > 240) { //full white all 0 for the no bg color. it means white or no bg set (white)
