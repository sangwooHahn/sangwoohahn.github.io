const discriptionList = [
  ...
  "experimental : Transfont is very experimental. Create a variety of forms by reflecting the user's appearance in real time. No one knows how it will change until they see the results for themselves.",
  ...
  "height : Indicates the height of the font. The font height of the transfont is fixed. However, it can have the same effect as adjusting height by adjusting width and font size.",
  ...
  "javascript : One of the programming languages used in web browsers, which helps Web pages work dynamically. It is a language that is responsible for the functional part of the transfont.",
  ...
  "microphone : It is an input device that accepts voice. Transfont uses this to accept the user's voice and to recognize and operate words.",
  ...
  "personal : Transfont is influenced by individual behavior and change their appearance.",
  ...
  "sound : Considering the characteristics of transfont that work in the form of fonts by hand and body, sound is another element that controls web pages.",
  ...
  "unredable : Transfont may not be read well. But it keeps the minimum form of the alphabet. It is very experimental.",
